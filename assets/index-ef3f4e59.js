(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))l(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&l(s)}).observe(document,{childList:!0,subtree:!0});function n(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerpolicy&&(a.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?a.credentials="include":r.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function l(r){if(r.ep)return;r.ep=!0;const a=n(r);fetch(r.href,a)}})();async function f(e){let t={status:!1,data:[]};return await fetch("https://api.comgig.com/thailand",{method:"POST",body:JSON.stringify(e),headers:{Authorization:`Bearer ${sessionStorage.getItem("X-TOKEN")||"1234567890"}`,"Content-type":"application/json; charset=UTF-8"},credentials:"include"}).then(function(n){n.ok?t=n.json():t={status:!1,message:"server error"}}).catch(()=>{t={status:!1,message:"api error"}}),t}function o(e,t=0,n=","){const l=parseFloat(e).toFixed(t).split("."),r=n===","?l[0].replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,"):l[0].replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1"+n);return String(r+(l[1]?"."+l[1]:""))}function G(e){var n;const t=document.querySelector("#response");t.innerHTML=`
...
`,(n=document.querySelector("#joinKBD"))==null||n.addEventListener("click",function(){var l;document.querySelector("#response").innerHTML=`
...
`,(l=document.querySelector("button"))==null||l.addEventListener("click",async function(){const r=document.querySelector("#kbd"),a=r==null?void 0:r.value.toUpperCase();if(a.length!==5){document.querySelector("#error").innerHTML="** รหัสไม่ถูกต้อง กรุณาลองใหม่อีกครั้ง";return}r.disabled=!0,this.disabled=!0;const s=await f({action:"join",value:a});console.log(s),s.status?document.querySelector("#response").innerHTML=`<div class="text-green-500 mt-6">
        <span class="material-symbols-outlined text-red-500 text-6xl animate-bounce block my-5">favorite</span>
        ขอบคุณที่เข้าร่วมโครงการ การเข้าร่วมครั้งนี้ของท่านจะช่วยให้ระบบมีข้อมูลที่แม่นยำมากยิ่งขึ้น</div>`:(r.disabled=!1,this.disabled=!1,document.querySelector("#error").innerHTML="ระบบขัดข้อง กรุณาลองใหม่อีกครั้ง")})}),setTimeout(async function(){window.scrollTo({top:0,behavior:"smooth"})},50)}const E="3.7.4",Q=E,W=typeof atob=="function",ee=typeof btoa=="function",u=typeof Buffer=="function",S=typeof TextDecoder=="function"?new TextDecoder:void 0,C=typeof TextEncoder=="function"?new TextEncoder:void 0,te="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",g=Array.prototype.slice.call(te),b=(e=>{let t={};return e.forEach((n,l)=>t[n]=l),t})(g),re=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,c=String.fromCharCode.bind(String),A=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):(e,t=n=>n)=>new Uint8Array(Array.prototype.slice.call(e,0).map(t)),q=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),F=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),M=e=>{let t,n,l,r,a="";const s=e.length%3;for(let i=0;i<e.length;){if((n=e.charCodeAt(i++))>255||(l=e.charCodeAt(i++))>255||(r=e.charCodeAt(i++))>255)throw new TypeError("invalid character found");t=n<<16|l<<8|r,a+=g[t>>18&63]+g[t>>12&63]+g[t>>6&63]+g[t&63]}return s?a.slice(0,s-3)+"===".substring(s):a},_=ee?e=>btoa(e):u?e=>Buffer.from(e,"binary").toString("base64"):M,w=u?e=>Buffer.from(e).toString("base64"):e=>{let n=[];for(let l=0,r=e.length;l<r;l+=4096)n.push(c.apply(null,e.subarray(l,l+4096)));return _(n.join(""))},y=(e,t=!1)=>t?q(w(e)):w(e),ne=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?c(192|t>>>6)+c(128|t&63):c(224|t>>>12&15)+c(128|t>>>6&63)+c(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return c(240|t>>>18&7)+c(128|t>>>12&63)+c(128|t>>>6&63)+c(128|t&63)}},se=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,R=e=>e.replace(se,ne),k=u?e=>Buffer.from(e,"utf8").toString("base64"):C?e=>w(C.encode(e)):e=>_(R(e)),x=(e,t=!1)=>t?q(k(e)):k(e),B=e=>x(e,!0),oe=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,le=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),n=t-65536;return c((n>>>10)+55296)+c((n&1023)+56320);case 3:return c((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return c((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},I=e=>e.replace(oe,le),P=e=>{if(e=e.replace(/\s+/g,""),!re.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,n="",l,r;for(let a=0;a<e.length;)t=b[e.charAt(a++)]<<18|b[e.charAt(a++)]<<12|(l=b[e.charAt(a++)])<<6|(r=b[e.charAt(a++)]),n+=l===64?c(t>>16&255):r===64?c(t>>16&255,t>>8&255):c(t>>16&255,t>>8&255,t&255);return n},$=W?e=>atob(F(e)):u?e=>Buffer.from(e,"base64").toString("binary"):P,K=u?e=>A(Buffer.from(e,"base64")):e=>A($(e),t=>t.charCodeAt(0)),z=e=>K(H(e)),ae=u?e=>Buffer.from(e,"base64").toString("utf8"):S?e=>S.decode(K(e)):e=>I($(e)),H=e=>F(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),m=e=>ae(H(e)),ie=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},Z=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),X=function(){const e=(t,n)=>Object.defineProperty(String.prototype,t,Z(n));e("fromBase64",function(){return m(this)}),e("toBase64",function(t){return x(this,t)}),e("toBase64URI",function(){return x(this,!0)}),e("toBase64URL",function(){return x(this,!0)}),e("toUint8Array",function(){return z(this)})},V=function(){const e=(t,n)=>Object.defineProperty(Uint8Array.prototype,t,Z(n));e("toBase64",function(t){return y(this,t)}),e("toBase64URI",function(){return y(this,!0)}),e("toBase64URL",function(){return y(this,!0)})},ce=()=>{X(),V()},L={version:E,VERSION:Q,atob:$,atobPolyfill:P,btoa:_,btoaPolyfill:M,fromBase64:m,toBase64:x,encode:x,encodeURI:B,encodeURL:B,utob:R,btou:I,decode:m,isValid:ie,fromUint8Array:y,toUint8Array:z,extendString:X,extendUint8Array:V,extendBuiltins:ce};function D(e){var a;const t=document.querySelector("#response");if(e.data.length===0){t.innerHTML='<div class="text-pink-600 h-96 flex  items-center justify-center">ไม่พบข้อมูลที่ค้นหา</div>';return}let n="",l="",r='<span class="material-symbols-outlined">location_on</span>';(a=e.data)==null||a.forEach(s=>{var d;let i="";if(s.esaSurcharged=="1"&&(i=s.province=="ภูเก็ต"?'<span class="text-blue-600">พื้นที่ท่องเที่ยวพิเศษ</span>':"พื้นที่ห่างไกล"),s.masterPostalCodeCapacities&&(i='<span class="text-orange-600">พื้นที่ล่าช้า (Official)</span>'),s.warningMessage&&(i=s.warningMessage=="งดรับพัสดุไปยังปลายทางดังกล่าวชั่วคราว!!"?'<span class="text-red-600 KanitBold">พื้นที่ปิดรับพัสดุ!</span>':s.warningMessage),s.postalCode!=n){n=s.postalCode;let p=(d=e.report)==null?void 0:d.find(Y=>Y.postcode==n);if(p.store=[s.linehualRoute,s.postalCode,s.amphur],l+=`<div class=" justify-between mt-2 pt-2 text-sm px-3 bg-gray-50 bg-opacity-80 flex md:hidden"><span>${s.province} ${s.postalCode}</span> ${i||"&nbsp;"}</div>`,l+=`<hr class="my-2 border-green-700" data-z${n}="${L.encode(JSON.stringify(p))}">`,!(p!=null&&p.con_total))return;(p.pending_3D+p.pending_4D+p.pending_5D+p.pending_OD)/p.con_pending*100>30?r='<span class="material-symbols-outlined text-amber-900 animate-bounce">location_on</span>':r='<span class="material-symbols-outlined text-green-800">location_on</span>',s.inactive&&(r='<span class="material-symbols-outlined text-deep-orange-700 animate-pulse">wrong_location</span>')}l+=`<div class="rounded-md cursor-pointer hover:outline hover:outline-2 hover:outline-orange-900 hover:animate-pulse" data-target="${s.postalCode}">
              <div class="flex justify-between items-center">
                  <div class="mt-1 text-sm text-gray-900 w-7">${r}</div>
                  ...
                  <div class="grow mt-1 text-xs text-orange-700 py-1 bg-gray-50 bg-opacity-80 hidden md:inline-block">${i||"&nbsp;"}</div>
                ...
                `:""}
            </div>`}),t.innerHTML=l,document.querySelectorAll("[data-target]").forEach(s=>{s.addEventListener("click",function(){const i=this.dataset.target,d=document.querySelector(`[data-z${i}]`).dataset[`z${i}`]??"",p=JSON.parse(L.decode(d));G(p)})})}var de=["second","minute","hour","day","week","month","year"];function pe(e,t){if(t===0)return["just now","right now"];var n=de[Math.floor(t/2)];return e>1&&(n+="s"),[e+" "+n+" ago","in "+e+" "+n]}var xe=["秒","分钟","小时","天","周","个月","年"];function ue(e,t){if(t===0)return["刚刚","片刻后"];var n=xe[~~(t/2)];return[e+" "+n+"前",e+" "+n+"后"]}var v={},J=function(e,t){v[e]=t},ge=function(e){return v[e]||v.en_US},h=[60,60,24,7,365/7/12,12];function U(e){return e instanceof Date?e:!isNaN(e)||/^\d+$/.test(e)?new Date(parseInt(e)):(e=(e||"").trim().replace(/\.\d+/,"").replace(/-/,"/").replace(/-/,"/").replace(/(\d)T(\d)/,"$1 $2").replace(/Z/," UTC").replace(/([+-]\d\d):?(\d\d)/," $1$2"),new Date(e))}function fe(e,t){var n=e<0?1:0;e=Math.abs(e);for(var l=e,r=0;e>=h[r]&&r<h.length;r++)e/=h[r];return e=Math.floor(e),r*=2,e>(r===0?9:1)&&(r+=1),t(e,r,l)[n].replace("%s",e.toString())}function be(e,t){var n=t?U(t):new Date;return(+n-+U(e))/1e3}var ye=function(e,t,n){var l=be(e,n&&n.relativeDate);return fe(l,ge(t))};J("en_US",pe);J("zh_CN",ue);async function he(e){const t=e.data.reduce((r,a)=>a.date?r+a.items:r+0,0),n=document.querySelector("#response");let l=`
...
<tbody class="text-lg">`;e.data.forEach(r=>{let a=0,s=0,i=0;r.status.forEach(d=>{d.status=="POD"?a+=d.items:d.status=="091"||d.status=="112"||d.status=="POD99"||d.status=="POD98"?i+=d.items:s+=d.items}),r.date&&(l+=`
...
style="width: ${o((a/r.items*100).toString())}%">
</div>
<div
class="flex h-full items-baseline justify-center overflow-hidden break-all bg-blue-300 text-white px-2"
style="width: ${o((s/r.items*100).toString())}%">
</div>
<div
class="flex h-full items-baseline justify-center overflow-hidden break-all bg-red-300 text-white px-2"
style="width: ${o((i/r.items*100).toString())}%">
</div>
    ...
    <td class="text-center text-gray-900">${o(r.items.toString())}</td>
    <td class="text-center text-green-800">${o(a.toString())} <span class="text-xs">(${o((a/r.items*100).toString())}%)</span></td>
    <td class="text-center text-blue-800">${o(s.toString())} <span class="text-xs">(${o((s/r.items*100).toString())}%)</span></td> 
    <td class="text-center text-red-800">${o(i.toString())} <span class="text-xs">(${o((i/r.items*100).toString())}%)</span></td> 
    ...
    `,n.innerHTML=l,o("1234",2)}document.querySelector("#app").innerHTML=`
...
</div>`;window.onload=async()=>{const e=document.querySelector("#response");e.classList.add("loader");const t=await f({action:"official",value:null});D(t),e.classList.remove("loader")};var T;(T=document.querySelector("#SearchInput"))==null||T.addEventListener("keyup",async function(e){!this.value||e.key==="Backspace"||we(this.value)});var N;(N=document.querySelector("#home"))==null||N.addEventListener("click",async function(){const e=document.querySelector("#SearchInput"),t=document.querySelector("#response");t.classList.add("loader");const n=e.value?"search":"official",l=await f({action:n,value:e.value});D(l),t.classList.remove("loader")});var j;(j=document.querySelector("#setting"))==null||j.addEventListener("click",async function(){const e=document.querySelector("#response");e.classList.add("loader");const t=await f({action:"setting"});he(t),e.classList.remove("loader")});var O;function we(e){const t=document.querySelector("#response");t.classList.add("loader"),clearTimeout(O),O=setTimeout(async function(){const n=await f({action:"search",value:e});D(n),t.classList.remove("loader")},1e3)}
