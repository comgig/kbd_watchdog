...
`,(n=document.querySelector("button"))==null||n.addEventListener("click",async function(){const s=document.querySelector("#kbd"),t=s==null?void 0:s.value.toUpperCase();if(t.length!==5){document.querySelector("#error").innerHTML="** รหัสไม่ถูกต้อง กรุณาลองใหม่อีกครั้ง";return}s.disabled=!0,this.disabled=!0;const c=await p({action:"join",value:t});console.log(c),c.status?document.querySelector("#response").innerHTML=`<div class="text-green-500 mt-6">
        ...
        ขอบคุณที่เข้าร่วมโครงการ การเข้าร่วมครั้งนี้ของท่านจะช่วยให้ระบบมีข้อมูลที่แม่นยำมากยิ่งขึ้น</div>`:(s.disabled=!1,this.disabled=!1,document.querySelector("#error").innerHTML="ระบบขัดข้อง กรุณาลองใหม่อีกครั้ง")})})}function x(e){var s;const o=document.querySelector("#response");if(e.data.length===0){o.innerHTML='<div class="text-pink-600 h-96 flex  items-center justify-center">ไม่พบข้อมูลที่ค้นหา</div>';return}let l="",i="",n='<span class="material-symbols-outlined">location_on</span>';(s=e.data)==null||s.forEach(t=>{var a;let c="";if(t.esaSurcharged=="1"&&(c=t.province=="ภูเก็ต"?"พื้นที่ท่องเที่ยวพิเศษ":"พื้นที่ห่างไกล"),t.masterPostalCodeCapacities&&(c="พื้นที่ล่าช้าตามประกาศ official"),t.warningMessage&&(c=t.warningMessage=="งดรับพัสดุไปยังปลายทางดังกล่าวชั่วคราว!!"?"พื้นที่ปิดรับพัสดุ":t.warningMessage),t.postalCode!=l){l=t.postalCode;let d=(a=e.report)==null?void 0:a.find(b=>b.postcode==l);if(d.store=`${t.linehualRoute} ${t.postalCode}`,i+=`<hr class="my-2 border-green-700" data-z${l}="${window.btoa(JSON.stringify(d))}">`,!(d!=null&&d.con_total))return;(d.pending_3D+d.pending_4D+d.pending_5D+d.pending_OD)/d.con_pending*100>30?n='<span class="material-symbols-outlined text-amber-900 animate-bounce">location_on</span>':n='<span class="material-symbols-outlined text-green-800">location_on</span>',t.inactive&&(n='<span class="material-symbols-outlined text-deep-orange-700 animate-pulse">wrong_location</span>')}i+=`<div class="rounded-md cursor-pointer hover:outline hover:outline-2 hover:outline-orange-900 hover:animate-pulse" data-target="${t.postalCode}">
...
<div class="container mx-auto px-4 text-center">
  <h1 class="text-2xl my-5">ระบบเช็กสถานะการพัสดุ</h1>
