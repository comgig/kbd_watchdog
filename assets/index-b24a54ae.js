...
`:""}
    ...
    <td class="text-center ${x>0?"text-red-800":"text-gray-500"}">${x||"-"}</td>
...
style="width: ${n((x/r.items*100).toString())}%">
    ...
    <td class="text-center text-red-800">${n(x.toString())} <span class="text-xs">(${n((x/r.items*100).toString())}%)</span></td> 
