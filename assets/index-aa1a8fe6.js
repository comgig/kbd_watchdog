(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerpolicy&&(i.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?i.credentials="include":r.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();async function g(e){let t={status:!1,data:[]};return await fetch("https://api.comgig.com/thailand",{method:"POST",body:JSON.stringify(e),headers:{Authorization:`Bearer ${sessionStorage.getItem("X-TOKEN")||"1234567890"}`,"Content-type":"application/json; charset=UTF-8"},credentials:"include"}).then(function(n){n.ok?t=n.json():t={status:!1,message:"server error"}}).catch(()=>{t={status:!1,message:"api error"}}),t}function l(e,t=0,n=","){const o=parseFloat(e).toFixed(t).split("."),r=n===","?o[0].replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,"):o[0].replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1"+n);return String(r+(o[1]?"."+o[1]:""))}function X(e){var n;const t=document.querySelector("#response");t.innerHTML=`
...
`,(n=document.querySelector("#joinKBD"))==null||n.addEventListener("click",function(){var o;document.querySelector("#response").innerHTML=`
...
`,(o=document.querySelector("button"))==null||o.addEventListener("click",async function(){const r=document.querySelector("#kbd"),i=r==null?void 0:r.value.toUpperCase();if(i.length!==5){document.querySelector("#error").innerHTML="** รหัสไม่ถูกต้อง กรุณาลองใหม่อีกครั้ง";return}r.disabled=!0,this.disabled=!0;const s=await g({action:"join",value:i});console.log(s),s.status?document.querySelector("#response").innerHTML=`<div class="text-green-500 mt-6">
        <span class="material-symbols-outlined text-red-500 text-6xl animate-bounce block my-5">favorite</span>
        ขอบคุณที่เข้าร่วมโครงการ การเข้าร่วมครั้งนี้ของท่านจะช่วยให้ระบบมีข้อมูลที่แม่นยำมากยิ่งขึ้น</div>`:(r.disabled=!1,this.disabled=!1,document.querySelector("#error").innerHTML="ระบบขัดข้อง กรุณาลองใหม่อีกครั้ง")})}),setTimeout(async function(){window.scrollTo({top:0,behavior:"smooth"})},50)}const U="3.7.4",V=U,J=typeof atob=="function",Y=typeof btoa=="function",x=typeof Buffer=="function",$=typeof TextDecoder=="function"?new TextDecoder:void 0,D=typeof TextEncoder=="function"?new TextEncoder:void 0,G="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",u=Array.prototype.slice.call(G),b=(e=>{let t={};return e.forEach((n,o)=>t[n]=o),t})(u),Q=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,a=String.fromCharCode.bind(String),S=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):(e,t=n=>n)=>new Uint8Array(Array.prototype.slice.call(e,0).map(t)),j=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),N=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),E=e=>{let t,n,o,r,i="";const s=e.length%3;for(let d=0;d<e.length;){if((n=e.charCodeAt(d++))>255||(o=e.charCodeAt(d++))>255||(r=e.charCodeAt(d++))>255)throw new TypeError("invalid character found");t=n<<16|o<<8|r,i+=u[t>>18&63]+u[t>>12&63]+u[t>>6&63]+u[t&63]}return s?i.slice(0,s-3)+"===".substring(s):i},w=Y?e=>btoa(e):x?e=>Buffer.from(e,"binary").toString("base64"):E,h=x?e=>Buffer.from(e).toString("base64"):e=>{let n=[];for(let o=0,r=e.length;o<r;o+=4096)n.push(a.apply(null,e.subarray(o,o+4096)));return w(n.join(""))},y=(e,t=!1)=>t?j(h(e)):h(e),W=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?a(192|t>>>6)+a(128|t&63):a(224|t>>>12&15)+a(128|t>>>6&63)+a(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return a(240|t>>>18&7)+a(128|t>>>12&63)+a(128|t>>>6&63)+a(128|t&63)}},ee=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,q=e=>e.replace(ee,W),C=x?e=>Buffer.from(e,"utf8").toString("base64"):D?e=>h(D.encode(e)):e=>w(q(e)),p=(e,t=!1)=>t?j(C(e)):C(e),A=e=>p(e,!0),te=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,re=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),n=t-65536;return a((n>>>10)+55296)+a((n&1023)+56320);case 3:return a((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return a((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},F=e=>e.replace(te,re),M=e=>{if(e=e.replace(/\s+/g,""),!Q.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,n="",o,r;for(let i=0;i<e.length;)t=b[e.charAt(i++)]<<18|b[e.charAt(i++)]<<12|(o=b[e.charAt(i++)])<<6|(r=b[e.charAt(i++)]),n+=o===64?a(t>>16&255):r===64?a(t>>16&255,t>>8&255):a(t>>16&255,t>>8&255,t&255);return n},v=J?e=>atob(N(e)):x?e=>Buffer.from(e,"base64").toString("binary"):M,R=x?e=>S(Buffer.from(e,"base64")):e=>S(v(e),t=>t.charCodeAt(0)),K=e=>R(I(e)),ne=x?e=>Buffer.from(e,"base64").toString("utf8"):$?e=>$.decode(R(e)):e=>F(v(e)),I=e=>N(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),m=e=>ne(I(e)),se=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},P=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),z=function(){const e=(t,n)=>Object.defineProperty(String.prototype,t,P(n));e("fromBase64",function(){return m(this)}),e("toBase64",function(t){return p(this,t)}),e("toBase64URI",function(){return p(this,!0)}),e("toBase64URL",function(){return p(this,!0)}),e("toUint8Array",function(){return K(this)})},H=function(){const e=(t,n)=>Object.defineProperty(Uint8Array.prototype,t,P(n));e("toBase64",function(t){return y(this,t)}),e("toBase64URI",function(){return y(this,!0)}),e("toBase64URL",function(){return y(this,!0)})},oe=()=>{z(),H()},k={version:U,VERSION:V,atob:v,atobPolyfill:M,btoa:w,btoaPolyfill:E,fromBase64:m,toBase64:p,encode:p,encodeURI:A,encodeURL:A,utob:q,btou:F,decode:m,isValid:se,fromUint8Array:y,toUint8Array:K,extendString:z,extendUint8Array:H,extendBuiltins:oe};function _(e){var i;const t=document.querySelector("#response");if(e.data.length===0){t.innerHTML='<div class="text-pink-600 h-96 flex  items-center justify-center">ไม่พบข้อมูลที่ค้นหา</div>';return}let n="",o="",r='<span class="material-symbols-outlined">location_on</span>';(i=e.data)==null||i.forEach(s=>{var f;let d="";if(s.esaSurcharged=="1"&&(d=s.province=="ภูเก็ต"?'<span class="text-blue-600">พื้นที่ท่องเที่ยวพิเศษ</span>':"พื้นที่ห่างไกล"),s.masterPostalCodeCapacities&&(d='<span class="text-orange-600">พื้นที่ล่าช้า (Official)</span>'),s.warningMessage&&(d=s.warningMessage=="งดรับพัสดุไปยังปลายทางดังกล่าวชั่วคราว!!"?'<span class="text-red-600 KanitBold">พื้นที่ปิดรับพัสดุ!</span>':s.warningMessage),s.postalCode!=n){n=s.postalCode;let c=(f=e.report)==null?void 0:f.find(Z=>Z.postcode==n);if(c.store=[s.linehualRoute,s.postalCode,s.amphur],o+=`<div class=" justify-between mt-2 pt-2 text-sm px-3 bg-gray-50 bg-opacity-80 flex md:hidden"><span>${s.province} ${s.postalCode}</span> ${d||"&nbsp;"}</div>`,o+=`<hr class="my-2 border-green-700" data-z${n}="${k.encode(JSON.stringify(c))}">`,!(c!=null&&c.con_total))return;(c.pending_3D+c.pending_4D+c.pending_5D+c.pending_OD)/c.con_pending*100>30?r='<span class="material-symbols-outlined text-amber-900 animate-bounce">location_on</span>':r='<span class="material-symbols-outlined text-green-800">location_on</span>',s.inactive&&(r='<span class="material-symbols-outlined text-deep-orange-700 animate-pulse">wrong_location</span>')}o+=`<div class="rounded-md cursor-pointer hover:outline hover:outline-2 hover:outline-orange-900 hover:animate-pulse" data-target="${s.postalCode}">
              <div class="flex justify-between items-center">
                ...
                `:""}
            </div>`}),t.innerHTML=o,document.querySelectorAll("[data-target]").forEach(s=>{s.addEventListener("click",function(){const d=this.dataset.target,f=document.querySelector(`[data-z${d}]`).dataset[`z${d}`]??"",c=JSON.parse(k.decode(f));X(c)})})}async function le(e){const t=e.data.reduce((r,i)=>i.date?r+i.items:r+0,0),n=document.querySelector("#response");let o=`
<div class="text-blue-800 my-6 text-sm md:text-xl">จำนวนพัสดุในระบบ ${l(t.toString())} ชิ้น</div>
...
<tr>
    ...
    <span class="">อัพเดตวันที่</span>
    </td>
    <td scope="col" class="KanitBold px-1 py-3 text-center">
    <span class="">จำนวนพัสดุ</span>

    </td>

</tr>
</thead>
<tbody class="text-lg">`;e.data.forEach(r=>{r.date&&(o+=`<tr class="bg-white border-b">
    <td scope="row" class="px-6 py-4 text-gray-900 whitespace-nowrap">
    ${r.date}
    </td>

    <td class="px-6 py-4 text-center">${r.items}
    </td>       
</tr>`)}),o+=`
</tbody>
</table>
    ...
    `,n.innerHTML=o,l("1234",2)}document.querySelector("#app").innerHTML=`
...
</div>`;window.onload=async()=>{const e=document.querySelector("#response");e.classList.add("loader");const t=await g({action:"official",value:null});_(t),e.classList.remove("loader")};var L;(L=document.querySelector("#SearchInput"))==null||L.addEventListener("keyup",async function(e){!this.value||e.key==="Backspace"||ie(this.value)});var O;(O=document.querySelector("#home"))==null||O.addEventListener("click",async function(){const e=document.querySelector("#SearchInput"),t=document.querySelector("#response");t.classList.add("loader");const n=e.value?"search":"official",o=await g({action:n,value:e.value});_(o),t.classList.remove("loader")});var T;(T=document.querySelector("#setting"))==null||T.addEventListener("click",async function(){const e=document.querySelector("#response");e.classList.add("loader");const t=await g({action:"setting"});le(t),e.classList.remove("loader")});var B;function ie(e){const t=document.querySelector("#response");t.classList.add("loader"),clearTimeout(B),B=setTimeout(async function(){const n=await g({action:"search",value:e});_(n),t.classList.remove("loader")},1e3)}
